...
class FeedServiceTest {
    ...
    void feedSel() {
        ...
        FeedCommentSelVo selvo9 = new FeedCommentSelVo();
        selvo9.setIfeedComment(9);
        selvo9.setComment("댓글2-5");
        feed2comment.add(selvo9);
        FeedCommentSelVo selvo10 = new FeedCommentSelVo();
        selvo10.setIfeedComment(10);
        selvo10.setComment("댓글2-6");
        feed2comment.add(selvo10);
